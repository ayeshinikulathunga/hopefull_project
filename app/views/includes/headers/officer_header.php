    ...
    <div class="admin-layout">
        ...
        <aside class="admin-sidebar" id="adminSidebar">
            <div class="sidebar-brand">
                ...
                <div class="admin-badge">Regional Officer</div>
            </div>
            
            <nav class="admin-nav">
                <ul>
                    <li class="<?php echo (strpos($_SERVER['REQUEST_URI'], 'dashboard') !== false) ? 'active' : ''; ?>">
                        <a href="<?php echo URLROOT; ?>/regionalOfficers/dashboard">
                            <i class="fas fa-tachometer-alt"></i>
                            <span>Dashboard</span>
                        </a>
                    </li>
                    <li class="<?php echo (strpos($_SERVER['REQUEST_URI'], 'inventory') !== false) ? 'active' : ''; ?>">
                        <a href="<?php echo URLROOT; ?>/regionalOfficers/inventory">
                            <i class="fas fa-boxes"></i>
                            <span>Inventory</span>
                        </a>
                    </li>
                    <li class="<?php echo (strpos($_SERVER['REQUEST_URI'], 'requests') !== false) ? 'active' : ''; ?>">
                        <a href="<?php echo URLROOT; ?>/regionalOfficers/requests">
            ...
            <header class="admin-header">
                ...
                <div class="header-right">
                    <div class="notification-icon">
                        ...
                        <?php 
                            $pendingCount = isset($data['pendingRequests']) ? count($data['pendingRequests']) : 0;
